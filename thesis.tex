...
\tikzstyle{layer} = [block, fill=orange!30, text width=6em, text centered]
\tikzstyle{database} = [cylinder, shape border rotate=90, aspect=0.3, draw, minimum height=4em, text centered, minimum width=3em]
\tikzstyle{frontend} = [block, text width=7em]
...
\lstdefinelanguage{JavaScript}{
  keywords={break, constructor, class, export, const, public, private, string, readonly case, catch, continue, debugger, default, delete, do, else, finally, for, function, if, in, instanceof, new, return, switch, this, throw, try, typeof, var, void, while, with},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
\mainmatter
\include{content/1_vorstellung}
\include{content/2_planung}
\include{content/3_entwicklung}
\include{content/4_bewertung-tech}
\include{content/5_bezug-studium}
